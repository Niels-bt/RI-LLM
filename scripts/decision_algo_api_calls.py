...
client = OpenAI(api_key=os.getenv("OPENAI_API_KEY", "sk-proj-oSTIAgCwMhVgCQJECVEbT3BlbkFJhiJrC3fYeCCywHvvJ7Jh"))
...
#api_key='sk-proj-oSTIAgCwMhVgCQJECVEbT3BlbkFJhiJrC3fYeCCywHvvJ7Jh'
